...
def main() -> None:
    ...
    # 3. Filter and Banned Word Handlers
    text_filters = filters.TEXT & ~filters.COMMAND
    # Filters and banned words must check for frozen state from within their respective functions
    ...
    # Answer Handler for Ranking (Must be before other handlers to capture poll updates accurately)
